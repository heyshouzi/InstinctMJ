"""Customized Booster T2 v3 robot asset definitions (G1-style naming)."""
...
# T2 resources directory (shared with V11)
...
def get_t2_v3_assets(meshdir: str | None) -> dict[str, bytes]:
    ...
    update_assets(assets, T2_RESOURCES_DIR + "/meshes", normalized_meshdir)
    return assets
...
# ============================================================================
# Motor constants (shared from V11)
# ============================================================================
...
ACTUATOR_5036_EFFORT_LIMIT = 16.0  # 高擎5036-02
