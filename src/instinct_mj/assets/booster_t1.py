...
_T1_INIT_STATE = EntityCfg.InitialStateCfg(
    ...
    joint_pos={
        ...
        "Left_Elbow_Pitch": 0.87,
        "Right_Elbow_Pitch": 0.87,
    },
    joint_vel={".*": 0.0},
)
...
# Motor output limits based on peak torque
# Effort limits (matching booster.py rated values)
ACTUATOR_4310_EFFORT_LIMIT = 18.0  # Arm
ACTUATOR_4315_EFFORT_LIMIT = 15.0  # Ankle_Roll
ACTUATOR_6408_EFFORT_LIMIT = 25.0  # Waist, Hip_Roll, Hip_Yaw
ACTUATOR_8112_EFFORT_LIMIT = 45.0  # Hip_Pitch
ACTUATOR_8116_EFFORT_LIMIT = 60.0  # Knee_Pitch
ACTUATOR_DMNA4310_EFFORT_LIMIT = 7.0  # Head
...
# Stiffness values derived from motor peak torque, normalized to 90Nm reference
# k_p = peak_torque / 1.0 (empirically derived scaling factor)
STIFFNESS_8116 = 118.0  # Knee - 118Nm peak
STIFFNESS_8112 = 90.0  # Hip-Pitch - 90Nm peak
STIFFNESS_4315 = 57.0  # Ankle - 57Nm peak
STIFFNESS_6408 = 40.0  # Waist/Hip-Roll/Hip-Yaw - 40Nm peak
STIFFNESS_4310 = 30.0  # Arm - 30Nm peak
STIFFNESS_DMNA4310 = 7.0  # Neck - 7Nm peak

# Damping values scaled proportionally
DAMPING_8116 = 2.7
DAMPING_8112 = 2.0
DAMPING_4315 = 1.3
DAMPING_6408 = 0.9
DAMPING_4310 = 0.7
DAMPING_DMNA4310 = 0.15
