...
_PARKOUR_DATASET_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file_dir__)))))), "t2_v3_retargeted_npz")
...
# T2 v3 body order (33 bodies, indices 0-32):
# 0: world (not counted)
# 1: trunk
# 2: head_yaw_link
# 3: head_pitch_link
# 4: left_shoulder_pitch_link
# 5: left_shoulder_roll_link
# 6: left_elbow_pitch_link
# 7: left_elbow_yaw_link
...
# 13: right_elbow_pitch_link
# 14: right_elbow_yaw_link
# 15: right_wrist_pitch_link
# 16: right_wrist_yaw_link
# 17: right_wrist_roll_link
# 18: waist_pitch_link
# 19: waist_roll_link
# 20: waist_yaw_link
# 21: left_hip_pitch_link
# 22: left_hip_roll_link
# 23: left_hip_yaw_link
# 24: left_knee_pitch_link
# 25: left_ankle_pitch_link
# 26: left_ankle_roll_link
# 27: right_hip_pitch_link
# 28: right_hip_roll_link
# 29: right_hip_yaw_link
# 30: right_knee_pitch_link
# 31: right_ankle_pitch_link
# 32: right_ankle_roll_link

motion_reference_cfg = MotionReferenceManagerCfg(
    name="motion_reference",
    entity_name="robot",
    robot_model_path=T2_v3_MJCF_PATH,
    link_of_interests=[
        "trunk",
        "head_yaw_link",
        "head_pitch_link",
    ...
    symmetric_augmentation_link_mapping=[
        ...
        6,  # right_elbow_yaw_link <-> left_elbow_yaw_link
...
def _parkour_t2_v3_spec() -> mujoco.MjSpec:
    ...
    UPPER_BODY_BODIES = {
        ...
        # Knee (can trigger overflow on sloped terrain)
    ...
    # T2 v3: left_ankle_roll_link already has mesh collision for foot
    # No need to add capsule cage like V11
    # The ankle_roll body IS the foot collision body

    # Foot bodies: left_ankle_roll_link / right_ankle_roll_link already have
    # collision mesh - keep as is. No separate foot body like V11.
...
def instinct_t2_v3_parkour_amp_env_cfg(
    *,
    ...
    if isinstance(joint_pos_action, JointPositionActionCfg):
        joint_pos_action.scale = copy.deepcopy(T2_v3_ACTION_SCALE)

    # Scene visual style
    cfg.scene.spec_fn = _edit_parkour_scene_spec

    # Scene sensors - T2 v3 uses left_ankle_roll_link and right_ankle_roll_link as feet
    cfg.scene.sensors = (
        ContactSensorCfg(
            name="contact_forces",
    ...
    cfg.commands = {
        "base_velocity": PoseVelocityCommandCfg(
            ...
            velocity_ranges={
                ...
                "square_gaps": {"lin_vel_x": (0.45, 1.0), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
                "boxes": {"lin_vel_x": (0.45, 1.0), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
                "hf_pyramid_slope_inv": {"lin_vel_x": (0.45, 1.0), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            },
    ...
    # T2 v3 joint name patterns (lowercase with underscores)
    policy_terms = {
    ...
    # Rewards - T2 v3 specific joint patterns (lowercase)
    cfg.rewards = {
        # ---------- Task rewards ----------
        ...
        # T2 v3 freeze upper body: arms (shoulder, elbow, wrist) and waist
